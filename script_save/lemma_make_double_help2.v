...
Axiom Q_real_log_less :
  forall (x:Reals.Rdefinitions.R) (y:Reals.Rdefinitions.R), (0%R < y)%R ->
  (x < y)%R -> (((Reals.Rpower.ln x) / (Reals.Rpower.ln y))%R < 1%R)%R.
...
(* Why3 goal *)
Theorem wp_goal :
  forall (r:Reals.Rdefinitions.R),
  let r1 :=
  ((Reals.Rbasic_fun.Rabs r) /
   (Reals.Rpower.Rpower 2%R (real_of_int (L_exponent r))))%R in
  ~ (r = 0%R) -> (1%R <= r1)%R /\ (r1 < 2%R)%R.
(* Why3 intros r r1 h1. *)
Proof.
  ...
  unfold real_of_int.
  unfold L_exponent.
  (* rewrite Floor_in_coq by apply Floor_down. *)

  assert (Rpower.ln (Rbasic_fun.Rabs r) * / Rpower.ln 2 * Rpower.ln 2 = Rpower.ln (Rbasic_fun.Rabs r))%R. {
    rewrite Real.Comm1 at 1.
    rewrite <- Real.Assoc1.
    rewrite Rinv_r_simpl_m.
    auto.
    apply Q_real_2__ln; auto.
  }

  split.
  (* + assert (IZR (floor (Rpower.ln (Rbasic_fun.Rabs r) / Rpower.ln 2))) *)
  + apply Real.Trans with
      (y := (Rbasic_fun.Rabs r / 
          Rpower.Rpower 2 (Rpower.ln (Rbasic_fun.Rabs r) / Rpower.ln 2))%R).

    * rewrite PowerReal.Pow_def.
      rewrite Real.infix_sl'def.
      rewrite Real.infix_sl'def.
      rewrite H.
      rewrite ExpLog.Exp_log; auto.
      field_simplify; auto.
      auto.
      apply Real.Refl.
      apply Rgt_not_eq.
      apply Rbasic_fun.Rabs_pos_lt.
      auto.
      apply Rbasic_fun.Rabs_pos_lt.
      auto.
    ...
    * rewrite Real.infix_sl'def.
      ...
      apply Rle_ge.
      apply Rbasic_fun.Rabs_pos.
      apply Rle_ge.
      apply Rinv_le_contravar.
      apply PowerReal.Pow_pos.
      apply Q_real_0_lt_2; auto.
      apply Rpower.Rle_Rpower.
      apply Rlt_le.
      apply Q_real_1_lt_2; auto.
      apply Floor_down.

  + apply Rlt_le_trans with
      (r2 := (Rbasic_fun.Rabs r / 
      Rpower.Rpower 2 (Rpower.ln (Rbasic_fun.Rabs r) / Rpower.ln 2 - 1))%R).

    * rewrite Real.infix_sl'def.
      apply Rgt_lt.
      rewrite Real.infix_sl'def.
      apply Rmult_gt_compat_l.
      apply Rbasic_fun.Rabs_pos_lt; auto.
      ...
      apply Rpower.Rpower_lt.
      apply Q_real_1_lt_2; auto.
      apply Rminus_lt.
      repeat rewrite Real.infix_mn'def.
      rewrite Real.Assoc.
      rewrite <- Ropp_plus_distr.
      rewrite <- Real.infix_mn'def.
      apply Rlt_minus.
      rewrite <- plus_IZR.
      rewrite Int.Comm.
      apply Floor_down.
    ...
    * rewrite Real.infix_mn'def.
      ...
      repeat rewrite Real.infix_sl'def.
      rewrite PowerReal.Pow_def.
      rewrite H.
      rewrite ExpLog.Exp_log; auto.
      field_simplify; auto.
      ...
      apply PowerReal.Pow_pos.
      apply Q_real_0_lt_2; auto.
      apply Rbasic_fun.Rabs_no_R0; auto.
      apply Rbasic_fun.Rabs_pos_lt; auto.
      apply Q_real_0_lt_2; auto.
Qed.
