...
Theorem wp_goal :
  ...
  ((floor
    ((Reals.Rpower.ln
      (real_of_int (4503599627370496%Z + (L_mantissa_64bit r))%Z))
     / (Reals.Rpower.ln 2%R))%R)
   = 52%Z).
(* Why3 intros r h1 h2. *)
Proof.
  intros r h1 h2.
  rewrite <- Q_mantissa_is_int; auto.
  unfold real_of_int.
  rewrite Rpower.ln_mult.
  rewrite Rdiv_plus_distr.
  rewrite Q_real_2_ln_52.
  rewrite Real.Comm.
  rewrite <- Q_floor_sum.
  rewrite Q_floor_zero; auto.

  apply Q_real_log_pos.
  apply Q_real_1_lt_2; auto.
  apply Q_make_double_help2; auto.

  apply Q_real_log_less.
  apply Q_real_1_lt_2; auto.
  apply Q_make_double_help2; auto.

  apply Q_make_double_help2; auto.
  rewrite <- Q_real_2_power_52.
  apply PowerReal.Pow_pos.
  apply Q_real_0_lt_2; auto.
  
  apply Rlt_le_trans with (r2 := 1%R).
  apply Rlt_0_1.
  apply Q_make_double_help2; auto.
Qed.
